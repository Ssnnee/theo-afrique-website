...
export const ProductSchema = z.object({
	...
	description: z
		...
		.max(512, {
			message: "La description ne doit pas dépasser 512 caractères",
		}),
	price: z.number(),
	...
	// Discount information (calculated from active announcement)
...
export const AnnouncementSchema = z.object({
	...
	title: z.string(),
	message: z.string(),
	type: z.enum(["sale", "promotion", "info", "warning"]),
...
export const ContactSchema = z.object({
	name: z
		.string()
		.min(5, { message: "Le champs doit contenir au moins 5 caractères" }),
	email: z
		.string()
		.email({ message: "Veullez entrer une adresse email valide" }),
	subject: z
		.string()
