  ...
  return (
    ...
    >
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent className="flex flex-col gap-4 text-balance">
          ...
          <p>
            ...
            confirmation de la commande. Pendant cette période, nous
            collaborons étroitement avec nos clients pour s&apos;assurer que
            chaque aspect du produit répond à leurs attentes. Nous offrons des
            options de personnalisation pour que chaque client puisse avoir un
            produit qui lui est propre.
          </p>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        ...
        <AccordionContent className="flex flex-col gap-4 text-balance">
          <p>
            ...
            produits. Les commandes sont généralement expédiées dans les 24 à
            48 heures suivant la confirmation de l&apos;achat ou la fin de la
            conception.
          </p>
          <p>
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent className="flex flex-col gap-4 text-balance">
          <p>
            Nous nous engageons à la satisfaction de nos clients. Si vous n&apos;
            êtes pas entièrement satisfait de votre achat, vous pouvez
