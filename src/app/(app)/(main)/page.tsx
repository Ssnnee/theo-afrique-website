		...
		<HydrateClient>
			<main className="px-3">
				<PageHeader>
					...
					<PageHeaderDescription>
						Découvrez l'harmonie parfaite entre l'artisanat traditionnel
						africain et le design contemporain. Explorez notre collection de
						vêtements, accessoires et objets d'art uniques qui célèbrent la
				...
				>
					<h1 className="mb-4 font-bold text-2xl"> Laissez-nous un message </h1>
				...
				<section
					...
					className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20"
				>
					<h1 className="mb-4 font-bold text-2xl"> À propos de nous</h1>
					<div className="mx-auto">
						<About />
					</div>
				</section>
