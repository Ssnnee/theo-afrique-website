	...
	const productList = [
		{
			...
			description:
				"Un t-shirt inspiré par les motifs traditionnels africains, alliant confort et style.",
			price: 29.99,
			imageUrl: "/1.jpg",
			sizes: ["S", "M", "L", "XL"],
		...
		},
		{
			...
			name: "Pagne",
			description:
				"Pagne traditionnel africain, parfait pour les occasions spéciales.",
			price: 29.99,
			imageUrl: "/8.jpg",
			sizes: ["S", "M", "L", "XL"],
			colors: ["Rouge", "Vert", "Bleu"],
		...
		},
		{
			...
			description:
				"Un sac à dos en tissu africain, idéal pour les sorties décontractées.",
			price: 49.99,
			imageUrl: "/3.jpg",
			sizes: ["M", "L"],
			colors: ["Noir", "Brun"],
